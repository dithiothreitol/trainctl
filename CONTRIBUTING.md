...
The full suite is 542 tests. Seven of them backtest the engine against a corpus
of real coaching plans; that corpus contains personal data, is not in the
repository, and those cases skip themselves when it is absent.
