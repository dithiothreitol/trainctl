...
| dalej | Starty B/C (T-9), pakiet startowy, siła 2×/tydz. (SportModule), dystrybucja npm/MCP, REST API | backlog w [docs/PLAN-v1.1.md](docs/PLAN-v1.1.md) — bez decyzji użytkownika nie zaczynać |
