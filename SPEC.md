...
| **6** | Profil z historii: `tren init --from-intervals` (inferencja objętości/dni/startów z intervals.icu, propozycje z proweniencją) | ZAPLANOWANE — [docs/PLAN-v1.1.md](docs/PLAN-v1.1.md) |
